...
public class KdlPsiPropImpl extends KdlElementImpl implements KdlPsiProp {

  public KdlPsiPropImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KdlPsiValue getValue() {
    return findNotNullChildByClass(KdlPsiValue.class);
  }
